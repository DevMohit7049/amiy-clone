const Footer = () => {
  ...
  return (
    <footer id="footer" className="bg-text-dark text-white">
      {/* Main footer content */}
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-12 md:py-16">
              ...
              <ul className="space-y-2.5">
                {section.links.map((link) => (
                  <li key={link}>
                    <a
                      href="#"
                      className="text-white/60 hover:text-accent text-xs md:text-sm transition-colors duration-200"
                    >
                      {link}
                    </a>
                  </li>
        ...
        {/* Social links */}
        <div className="mt-10 md:mt-14 pt-8 border-t border-white/10">
            ...
            <div className="flex items-center gap-4">
              ...
              {socialLinks.map((social) => (
                <a
                  key={social.name}
                  href="#"
                  className="text-white/60 hover:text-accent transition-colors duration-200 p-2"
      ...
      <div className="bg-black/20 py-4">
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <p className="text-white/40 text-xs text-center">
            &copy; {new Date().getFullYear()} Amiy Naturals. All rights reserved. | Designed with care for your wellness journey.
          </p>
        </div>
      </div>
    </footer>
